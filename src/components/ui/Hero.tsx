...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden bg-gradient-to-b from-background to-background/80">
      {/* Abstract background shapes */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-r from-primary/20 to-secondary/20 blur-3xl rounded-full transform rotate-12 animate-pulse" />
        <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-l from-primary/10 to-secondary/10 blur-3xl rounded-full transform -rotate-12 animate-pulse delay-1000" />
      </div>
      ...
      <div className="container px-4 py-16 md:py-24 flex flex-col items-center text-center relative z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-fade-up animation-delay-200">
          <Button size="lg" className="px-8 rounded-full bg-gradient-to-r from-primary to-primary hover:opacity-90 transition-opacity" asChild>
            <a href="#portfolio" className="font-medium">View My Work</a>
          </Button>
          <Button size="lg" variant="outline" className="px-8 rounded-full border-2 hover:bg-primary/5 transition-colors" asChild>
